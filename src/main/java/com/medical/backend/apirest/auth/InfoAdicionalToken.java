...
public class InfoAdicionalToken implements TokenEnhancer{
	...
	public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
		...
		//Profesional profesional = catalogoService.findCatalogoByMedicoxIdUser(iduser);
		...
		//info.put("cmp", profesional.getCmp());
		//info.put("especialidad", profesional.getEspecialidad().getNombre());
